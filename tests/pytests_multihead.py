...
if __name__ == "__main__":
    ...
    assert (report["val_metrics"]['task2 regression_accuracy'][0] < report["val_metrics"]['task2 regression_accuracy'][-1]) or (report["val_metrics"]['task2 regression_accuracy'][0] < report["val_metrics"]['task2 regression_accuracy'][-2]),  "Test 1-b : task 2 accuracy did not improve with training - TEST FAILED"
